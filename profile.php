...
<form action="PHP/alterar_senha.php" method="POST">
  <div class="row g-3 align-items-center">
    <div class="col-auto">
      <label for="senha_atual" class="col-form-label">Senha Atual:</label>
    </div>
    <div class="col-auto">
      <input type="password" class="form-control" name="senha_atual" aria-labelledby="passwordHelpInline" required>
    </div>
  </div>
  <br>
  <div class="row g-3 align-items-center">
    ...
    <div class="col-auto">
      <input type="password" class="form-control" name="nova_senha" aria-labelledby="passwordHelpInline" required>
    </div>
  </div>
  <br>
...
<form action="PHP/alterar_foto.php" method="POST" enctype="multipart/form-data">
  <label for="nova_foto"></label>
